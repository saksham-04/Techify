          ...
          <div id="collapseFive" className="accordion-collapse collapse " aria-labelledby="headingFive" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              ...
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>What do IT project managers do?
                ...
                1.	Earn an undergraduate degree. Apply to a college or university and enroll in a bachelor's degree program in an applicable field. ...
                2.	Gain work experience. It's important to apply to and work in entry-level positions in information technology. ...
                3.	Become certified. ...
                4.	Apply for jobs.
              </p>
              ...
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>
                ...
                four to eight years
                How Long Does It Take to Become an IT Manager? Becoming an IT manager can take four to eight years. Entry-level roles only ask for a bachelor's de  gree, but you will need more experience to get a better job. Certifications, extra courses, or a master's degree can help you get there
                What is salary package of IT project manager?
                Project Manager salary in India ranges between ₹ 4.8 Lakhs to ₹ 26.0 Lakhs with an average annual salary of ₹ 14.1 Lakhs. Salary estimates are based on 97.4k salaries received from Project Managers.
              </p>
            </div>
          </div>
        </div>
          ...
          <div id="collapseSix" className="accordion-collapse collapse " aria-labelledby="headingSix" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              ...
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>Information security analysts typically do the following: Monitor their organization's networks for security breaches and investigate when one occurs. Use and maintain software, such as firewalls and data encryption programs, to protect sensitive information. Check for vulnerabilities in computer and network systems
                ...
                •	Cloud. ...
                •	DevOps.
                Does information security analyst require
                coding?
                ...
                What is the highest position in information security?
                ...
                CompTIA Security+
                Security+ certification is the most basic requirement needed for a career as an Information Security Analyst. It's a foundational, vendor-neutral certification that validates basic knowledge of network security and risk management.
              </p>
            </div>
          </div>
        </div>
          ...
          <div id="collapseSeven" className="accordion-collapse collapse " aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              ...
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>The roles of a system architect
                ...
                What skills do you need to be a systems architect?
                Qualities to be a system architect
                •	Analytical skills and ability to see the big picture.
                •	Good communication and teamwork skills.
                •	High degree of curiosity about new technologies.
                •	Ability to adapt.
                •	Negotiation and persuasion skills.
                What are 5 skills architects need?
                Here are five crucial skills you need to begin a career in architecture.
                ...
                •	A professional looking to work as a system architect should earn a bachelor degree in software engineering or computer science. The program may include coursework in web design and programming, network infrastructure and database administration.
                What is the starting salary for a System Architect in India?
                Average starting Salary for System Architect in India is around ₹6.2 Lakhs per year (₹51.7k per month). 3 years of minimum experience is required to be a System Architect.
                How to Become a Systems Architect
                The qualifications to become a systems architect include a bachelor's degree in computer science, software engineering, or a related field, experience with computer programming, systems architecture, and information technology, and strong speaking and writing skills. You must be proficient with Linux operating systems, integrated development environments, TCP/IP, and other tools and technologies related to systems architecture. A bachelor's degree and limited experience qualify you for an entry-level systems architect job, and professional certifications may help advance your career. Consider the Project Management Professional (PMP) credential or certification through the Information Technology Infrastructure Library (ITIL).
              </p>
            </div>
          </div>
        </div>
          ...
          <div id="collapseEight" className="accordion-collapse collapse " aria-labelledby="headingEight" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              ...
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>Artificial Intelligence (AI) is a computer system’s ability to mimic human behavior. Machines demonstrate this sort of intelligence, which can be compared to a natural intelligence that humans and animals demonstrate.
                ...
                To give yourself a competing chance for AI engineering careers and increase your earning capacity, you may consider getting Artificial Intelligence Engineer Master's degree in a similar discipline. It might provide you with a comprehensive understanding of the topic as well as specialized technical abilities. You may be required to take the GATE exam in order to enroll in an engineering program.On the other hand, participating in Artificial Intelligence Courses or diploma programs may help you increase your abilities at a
                lower financial investment. There are graduate and post-graduate degrees available in artificial intelligence and machine learning that you may pursue. You may get online certifications at your own speed via a variety of platforms, such as Simplilearn, which provides online training courses.</p>
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          <div id="collapseNine" className="accordion-collapse collapse " aria-labelledby="headingNine" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>Computer hardware engineers research, design, develop, and test computer systems and components such as circuit boards. Computer hardware engineers research, design, develop, and test computer systems and components such as processors, circuit boards,
                ...
                How Long Does It Take to Become a Computer Hardware Engineer? A bachelor's degree in this subject takes about four years; acquiring professional certifications and conducting a job search takes additional time.
                ...
                •	Speaking skills.
                Where does a computer hardware engineer work?
                ...
                Careers Related to Computer Hardware Engineers
                ...
                What is the starting salary for a Computer Hardware Engineer in India?
                Average starting Salary for Computer Hardware Engineer in India is around ₹0.2 Lakh per year (₹1.7k per month). 1 year of minimum experience is required to be a Computer Hardware Engineer.
              </p>
            </div>
          </div>
        </div>
          ...
          <div id="collapseTen" className="accordion-collapse collapse " aria-labelledby="headingTen" data-bs-parent="#accordionExample">
            <div className="accordion-body">
              <p style={{ fontFamily: 'Copperplate Gothic Light', color: '#001a6a' }}>What does a video game developer do? Video game developers, also known as games developers or video game programmers, write code for games for a variety of formats, such as PCs, consoles, web browsers and mobile phones.
                ...
                What education is needed to become a videogame developer?
                bachelor's degree
                ...
                8.	Get a job at a gaming studio in a non-game development position.

                What is a good career for a gamer?
                ...
                Game Designer, Game Developer, Game Tester, Game Animator, Visual Artist, Audio Engineer, Interpreters and Translators, and Market Research Analyst are some of the many career options that can be pursued after gathering the required skills
